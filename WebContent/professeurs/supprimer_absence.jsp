...
<td align="center">Date Absence</td>
...
String prof=name+" "+preno;
				...
				absenceInterface abs=new absenceImp();
				for( absence ab:abs.getALLAbsences(prof))
				{%>
				<tr height="50">
				<td align="center"><%=ab.getEt_matricule()%></td>
				   <td align="center"><%=ab.getDate()%></td>
				   <td align="center"><%=ab.getClasse()%></td> 
				        <td align="center"><a href="../absence?action=delete&id=<%=ab.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
