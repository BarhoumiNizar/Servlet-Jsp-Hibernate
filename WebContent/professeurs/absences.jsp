...
<div class="wrapper">
  ...
  <aside class="main-sidebar" style="width:320px;">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
       ...
       <li>
          <a href="professeurs/emploie_du_temps.jsp">
 ...
 %>
  ...
  String etudiants=request.getParameter("et_matricule");
   %>
  <div class="group">
  <input type="hidden" name="action" value="ajout">
   ...
   <input name="seance" readonly="readonly" value="<%=request.getParameter("seance") %>" >
   ...
   <input readonly="readonly" name="classe" value="<%=classe%>" >
