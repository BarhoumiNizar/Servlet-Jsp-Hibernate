...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
							...
							absenceInterface cl=new absenceImp();
						 /*Pour remplir le formulaire*/
						  for( absence cls:cl.getALLAbsences(prof))
						  {
							 if(cls.getId()==id_update) 
							 {
								 classe=cls.getClasse();
								  seance=cls.getSeance();
									 date=cls.getDate(); 
									 etudiant=cls.getEt_matricule(); 
						...
						%>
							...
							<tr>
							<td width=180 align="center"><b style="font-size: 24px;color:red">Classe</b></td>
							<td width=180 align="center"><b style="font-size: 24px;color:red">Matiere</b></td>
							<td width=180 align="center"><b style="font-size: 24px;color:red">Etudiant</b></td>
							<td width=180 align="center"><b style="font-size: 24px;color:red">Date</b></td>
							
							</tr>
							<tr>
							
							<td width=280 align="center"><b style="font-size: 18px"><%=classe %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=seance %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=etudiant %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=date %></b></td>
							
							</tr>
							<tr><td colspan=5 align=right><a href="#" onclick="window.print();document.location.href='recherche_absence.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" style="float:right;position: relative; top:-125px;left:20px" href="#" onclick="document.location.href='recherche_absence.jsp'">&times;</a>
