...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1>Supprimer Notification</h1>
 
</hgroup>
<table width="75%" align="center" border="1">
<tr><td align="center">Classe</td><td align="center">Contenu</td>
...
String prof=name+" "+preno;
				...
				for(notification notifs:notif.getALLnotification(prof))
				{%>
				<td align="center"><%=notifs.getClasse() %></td>
				
				<td align="center"><%=notifs.getContenu() %></td>
				
				
			 <td align="center"><a href="../notification?action=delete&id=<%=notifs.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
