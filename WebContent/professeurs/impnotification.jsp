...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  notificationInterface cl=new notificationImp();
						 /*Pour remplir le formulaire*/
						  for( notification cls:cl.getALLnotification(prof))
						  {
							 if(cls.getId()==id_update) 
							 {
								 classe=cls.getClasse();
								  description=cls.getContenu();
									 type=cls.getType(); 
									 date=cls.getDate_notification(); 
						...
						%>
							...
							<td align="center" style="color:red">Classe</td>
                             ...
                             <td align="center" style="color:red">Description</td>
                             <td align="center" style="color:red">Date</td>
							...
							<td width=180 align="center"><b style="font-size: 18px"><%=description %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=date %></b></td>
							
							</tr>
							<tr><td colspan=8 align=right><a href="#" onclick="window.print();document.location.href='recherche_notification.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" style="float:right;position: relative; top:-120px;left:20px" href="#" onclick="document.location.href='recherche_notification.jsp'">&times;</a>
