...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  notesInterface cl=new notesImp();
						 /*Pour remplir le formulaire*/
						  for( Examen cls:cl.getALLNotes(prof))
						  {
							 if(cls.getId()==id_update) 
							 {
								 classe=cls.getClasse();
								  matiere=cls.getMat();
									 etudiant=cls.getEtudiant(); 
									 coefficient=cls.getExamen_coefficient(); 
									 note=cls.getExamen_note();
									 date=cls.getExamen_date(); 
									 h_debut=cls.getExamen_heure_debut(); 
									 h_fin=cls.getExamen_heure_fin(); 
									 type=cls.getExamen_type(); 
						...
						%>
							...
							<tr>
							<td align="center" style="color:red">Nom Matiere</td>
                             <td align="center" style="color:red">Classe</td>
                             <td align="center" style="color:red">Matricule Etudiant</td>
                             <td align="center" style="color:red">Type examen</td>
                             <td align="center" style="color:red">Note examen</td>
                             <td align="center" style="color:red">Date examen</td>
                             <td align="center" style="color:red">Heure debut</td>
                             <td align="center" style="color:red">Heure fin</td>
							</tr>
							<tr>
							
							<td width=180><b style="font-size: 18px"><%=matiere %></b></td>
							<td width=180><b style="font-size: 18px"><%=classe %></b></td>
							<td width=180><b style="font-size: 18px"><%=etudiant %></b></td>
							<td width=180><b style="font-size: 18px"><%=type %></b></td>
							<td width=180><b style="font-size: 18px"><%=note %></b></td>
							<td width=180><b style="font-size: 18px"><%=date %></b></td>
							<td width=180><b style="font-size: 18px"><%=h_debut %></b></td>
							<td width=180><b style="font-size: 18px"><%=h_fin %></b></td>
							</tr>
							<tr><td colspan=8 align=right><a href="#" onclick="window.print();document.location.href='recherche_note.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" style="float:right;position: relative; top:-155px;left:20px" href="#" onclick="document.location.href='recherche_note.jsp'">&times;</a>
