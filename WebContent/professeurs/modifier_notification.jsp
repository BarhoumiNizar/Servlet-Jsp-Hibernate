...
String prof=name+" "+preno;
       ...
       //pour parcourire le resultat users
				...
				{%>
				<tr height="50" <% if(notif.getEtat().equals("ok")) {%> bgcolor="red" <% } %>>
				<td align="center"><%=notif.getDate_notification()%></td>
				   <td align="center"><%=notif.getType()%></td>  
				   <td align="center"><%=notif.getContenu()%></td>  
				   <td align="center"><%=notif.getClasse()%></td>    
				        <td align="center"><a href="update_notification.jsp?action=update&id=<%=notif.getId()%>" >
