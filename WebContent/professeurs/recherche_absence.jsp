...
<table width=100%>
<tr>
<td width=20% valign="top" style="margin-right: 50px">
  ...
  <label style="position: relative; top: 0px">Classe</label>
    ...
    <% 
				//pour parcourire le resultat users
				matiereInterface mt=new matiereImp();
				for( matiere mts:mt.getALLMatieres())
				{%>
      <option><%=mts.getMat_nom() %></option>
      <% } %>
    </select>
     <span class="highlight"></span>
    <span class="highlight"></span>
    <br> <label style="position: relative; top: 0px" >Date</label><br>
...
<td valign="top"  style="position: relative; left: 50px">
 <%
...
<td align="center" width="120">Date absence</td>
...
<%if(request.getParameter("classe")!=null) 
{
	...
	String matiere=request.getParameter("matiere"); 
				//pour parcourire le resultat users
				absenceInterface sn=new absenceImp();
				int tail=sn.getAbsence(classe, matiere, prof, date).size();
				
			for( absence sns:sn.getAbsence(classe, matiere, prof, date))
				{
					
				
				%>
					<tr height="50">
					 <td align="center"><a href="impabsence.jsp?id=<%=sns.getId()%>#popup1"><%=sns.getClasse()%></a></td> 
				<td align="center"><%=sns.getSeance() %></td>
				<td align="center"><%=sns.getEt_matricule()%></td> 
	<td align="center"><%=sns.getDate()%></td> 
    	   ...
    	   absenceInterface sn=new absenceImp();
    		for( absence sns:sn.getALLAbsences(prof))
    			{
