...
<td width=20% valign="top" style="margin-right: 50px">
  ...
  <label style="position: relative; top: 0px">Classe</label>
    ...
    <span class="highlight"></span>
     <label style="position: relative; top: 0px">Type</label><br>
    <select name="type">
    <option>pfe</option>
      <option>pfa</option>
...
<td align="center" width="160">Classe</td>
<td align="center" width="100">Type</td>
<td align="center" width="160">Sujet</td>
<td align="center" width="120">Entreprise</td>
<td align="center" width="160">Date de début</td>
<td align="center" width="160">Date de fin</td>
...
<%if(request.getParameter("classe")!=null) 
{
	...
	String type=request.getParameter("type"); 
				...
				//pour parcourire le resultat users
				stageInterface st=new stageImp();
				
				
			for( stage sts:st.getStages(prof))
				{
					if(sts.getClasse().equals(classe) && sts.getStg_type().equals(type))
					{
				%>
					<tr height="50">
					 <td align="center"><a href="impstage.jsp?id=<%=sts.getId()%>#popup1"><%=sts.getClasse()%></a></td> 
				<td align="center"><%=sts.getStg_type() %></td>
				<td align="center"><%=sts.getStg_sujet()%></td> 
	<td align="center"><%=sts.getStg_entreprise()%></td> 
	<td align="center"><%=sts.getStg_date_debut()%></td> 
	<td align="center"><%=sts.getStg_date_fin()%></td> 
