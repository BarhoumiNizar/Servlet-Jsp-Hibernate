...
<%if(request.getParameter("classe")!=null) 
{
	...
	//String matiere=request.getParameter("matiere"); 
				//pour parcourire le resultat users
				notificationInterface sn=new notificationImp();
			for( notification sns:sn.getALLnotification(prof))
				{
				...
				<td align="center"><a href="impnotification.jsp?id=<%=sns.getId()%>#popup1"><%=sns.getClasse()%></a></td>
				<td align="center"><%=sns.getType()%></td> 
	<td align="center"><%=sns.getContenu()%></td> 
	
	<td align="center"><%=sns.getDate_notification()%></td> 
