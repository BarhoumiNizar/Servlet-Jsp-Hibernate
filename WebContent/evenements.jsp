			...
			<ul >
				...
				<li id="formations"><a class="principal" href="#" accesskey="2" title="">Formations</a>
				 ...
				 <ol class="sous_menu_etudiant">
							   <li><a  href="cycle_preparatoire.jsp">Pré-inscription</a></li>
							    <li><a href="admission.jsp">Admission</a></li>
								 <li><a href="master.jsp">Guide de l'étudiant</a></li>
								  <li><a href="etudes.jsp">Etudiants internationaux</a></li>
...
<div class="title">
	...
	<td>
	 ...
	 <img src="images/evenements/ev1.jpg" width="250" height="200" style="float:left; vertical-align: left"/>
	 </td>
	   <td valign="top" style="font-size: 20px"> Journée culturelle libyenne</td>
	   </tr>
	 <tr>
	<td>
	
	 <img src="images/evenements/ev2.jpg" width="250" height="200" style="float:left"/>
	 </td>
	   <td valign="top" style="font-size: 20px"> L'Université Arabe Des Sciences honore la savante tunisienne "Hayet El Amri"

L’université arabe des sciences honore la savante tunisienne « Hayet El Amri »</td>
	   </tr>
	   <tr>
	<td>
	
	 <img src="images/evenements/ev3.jpg" width="250" height="200" style="float:left"/>
	 </td>
	   <td valign="top" style="font-size: 20px"> L'Université Arabe Des Sciences honore le savant tunisien "Foued ElKamel"

L’Université Arabe Des Sciences honore le savant tunisien « Foued ElKamel« </td>
	   </tr>
	   <tr>
	<td>
	
	 <img src="images/evenements/ev4.jpg" width="250" height="200" style="float:left"/>
	 </td>
	   <td valign="top" style="font-size: 20px"> L'Université Arabe Des Sciences honore l'enseignant Universitaire "Sylvie De Cozak"

L’Université Arabe Des Sciences honore l’enseignant Universitaire « Sylvie De Cozak »</td>
	   </tr>
	   <tr>
	<td>
	
	 <img src="images/evenements/ev5.jpg" width="250" height="200" style="float:left"/>
	 </td>
	   <td valign="top" style="font-size: 20px"> Convention entre l'Université Arabe des Sciences et le centre national de Recherche Tunisien

Convention entre l’Université Arabe des Sciences et le centre national de Recherche Tunisien</td>
	   </tr>
	   <tr>
	<td>
	
	 <img src="images/evenements/ev6.jpg" width="250" height="200" style="float:left"/>
	 </td>
	   <td valign="top" style="font-size: 20px"> Convent entre l'Université Arabes des Sciences et l'université Mohamed I du Maroc

Convent entre l’Université Arabes des Sciences et l’Université Mohamed I du Maroc</td>
	   </tr>
