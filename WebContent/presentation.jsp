...
<div class="title">
	  ...
	  <h2><!-- Titre --></h2>
	  <img src="images/presentation/uas1.jpg" width="250" height="200"/>
	   <img src="images/presentation/uas.jpg" width="250" height="200"/>
	   <img src="images/presentation/uas2.jpg" width="250" height="200"/>
	   
	  
		</div>
		<p style="font-size: 20px">
		L’Université Arabe des Sciences fait partie du plus grand groupe universitaire privé de Tunisie: le Groupe de l'Education et des Sciences.
Outre l'UAS Tunis, ce groupe comprend :
		
          </p>
         <p style="font-size: 20px">	Une université au Gabon, l'Université Africaine des Sciences UAS Libreville</p>
          
          <p style="font-size: 20px">Deux instituts de formation professionnelle: l'Institut d'Administration des Entreprises (IAE Tunis, IAE Libreville)</p>
          <p style="font-size: 20px">4 écoles primaires: Salim School à Ennasr, Salima School à Ezzahra, Salim School au Bardo et Lamis School à El mourouj,</p>
          <p style="font-size: 20px">2 collèges à Ennasr et à Ezzahra,</p>
          <p style="font-size: 20px">Un centre de formation à Ryadh en Arabie Saoudite.</p>
           <p style="font-size: 20px">Le groupe est autorisé à ouvrir une université au Mali et une faculté de médecine au Tchad. Cela témoigne du sérieux de la formation qu’il assure et du rayonnement  international réalisé par le groupe</p>
            <p style="font-size: 20px">Fondée en 1993 L’AUS fait partie d’un groupe qui va de l’enseignement du primaire au mastère. 
            C’est la première université privée  créée par des universitaires en Tunisie. Elle s’est développée avec les années pour devenir la plus grande université privée du pays au moment où elle compte plus de 30 nationalités,
             200 enseignants universitaires et des relations avec des universités situées sur les cinq continents.</p>
