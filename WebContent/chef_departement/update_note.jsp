...
<form method="post" action="../notes" id="form">
 <%
  ...
  <div class="group">
    <input type="time" name="examen_heure_debut" value="<%=debut %>"><span class="highlight"></span><span class="bar"></span>
  
  </div>
  <div class="group">
    <input type="time" name="examen_heure_fin" value="<%=fin %>"><span class="highlight"></span><span class="bar"></span>
  ...
  <div class="group">
    <input type="text" name="coefficient" value="<%=coefficient %>"placeholder="coeficient"><span class="highlight"></span><span class="bar"></span>
  ...
  %>
   ...
   <div class="group">
    <input type="text" name="note" value="<%=not %>" placeholder="note"><span class="highlight"></span><span class="bar"></span>
