...
%>
 ...
 <table width="80%" align="center" border=2 style=" border:5px solid black;" >
...
<% 
				...
				for( seance scs:sc.EmploiseanceProf(prof,request.getParameter("jour")))
				{%>
				<tr height="50">
				       ...
				       <td align="center"><%=scs.getClasse()%></td>
				        <td align="center"><%=scs.getSalle()%></td>
				        </tr>
