...
<form method="post" action="../classe" id="form">
  ...
  <input type="hidden" name="action" value="ajout">
   <input type="hidden" name="departement" value="<%=departement%>">
    <input type="text" name="class_nom" placeholder="Nom de la classe" required="required">
  ...
  <button type="submit" class="button buttonBlue">Créer Classe
