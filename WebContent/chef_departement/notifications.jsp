...
<form method="post" action="../notification" id="form">
  ...
  <input type="hidden" name="etat" value="non">
    <input type="date" name="date_notification" placeholder="matricule"><span class="highlight"></span><span class="bar"></span>
    
  </div>
  <div class="group">
    
   <span style="position: relative;top: -10px"> Rattrapage</span><input type="radio" name="type" value="rattrapage" style="width:25px; height: 25px;border-radius:50%;position: relative;left:10px">
       <span style="position: relative;left:10px; top: -10px">Absence</span><input type="radio" name="type" value="absence" style="width:25px; height: 25px;border-radius:50%;position: relative;left:20px">
     <span style="position: relative;left:20px; top: -10px">Autre</span><input type="radio" name="type" value="Autre" style="width:25px; height: 25px;border-radius:50%;position: relative;left:30px">
  ...
  <div class="group">
    <input type="text" name="contenu" placeholder="description"><span class="highlight"></span><span class="bar"></span>
