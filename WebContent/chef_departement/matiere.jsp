...
<form method="post" action="../matiere" id="form">
  ...
  <input type="hidden" name="action" value="ajout">
    ...
    <input type="text" name="mat_nom" placeholder="Nom de matiere" required="required">
    <span class="highlight"></span>
    
  </div>
   <div class="group">
  
    <input type="number" name="mat_mass_horaire" placeholder="masse horaire" required="required">
    <span class="highlight"></span>
  ...
  <div class="group">
    ...
    <input type="text" name="mat_coefficient" placeholder="coefficient" required="required">
    <span class="highlight"></span>
    
  </div>
  <button type="submit" class="button buttonBlue">Créer Matiere
