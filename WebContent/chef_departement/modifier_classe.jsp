...
<% 
				...
				{
				 if(cls.getDepartement().equals(dep))
				 {
				%>
				<tr  <% if(cls.getEtat().equals("oui")) {%> bgcolor="red" <% } %> >
				<td align="center"><%=cls.getClass_nom()%></td>
				   <td align="center"><%=cls.getFiliere()%></td>    
				        <td align="center"><a href="update_classe.jsp?action=update&id=<%=cls.getId()%>" >
