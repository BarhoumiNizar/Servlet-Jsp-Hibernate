...
<!-- Le contenu -->
<h1 style="color:blue">Recherche Filiere</h1>
<table width=100%>
<tr>
...
<%
				...
				%>
				<tr>
				<td align="center"><a href="impfil.jsp?id=<%=fl.getId()%>#popup1"><%=fl.getFlr_nom()%></a></td>
...
<tr height="50"><td colspan="2" align="right"><a href="#" id="impression" >Imprimer</a></td></tr>
</table>
