...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						 ...
						 /*Pour remplir le formulaire*/
						  for( matiere mts:mt.getALLMatieres())
						  {
							 if(mts.getId()==id_update) 
							 {
								 ...
								 masse_horaire=mts.getMat_mass_horaire();
								 coefficient=mts.getMat_coefficient();
						...
						%>
							...
							<td width=180><b style="font-size: 24px;color:red">Masse Horaire</b></td>
							<td width=180><b style="font-size: 24px;color:red">Coefficient</b></td>
							</tr>
							<tr>
							
							<td width=180 align="center"><b style="font-size: 18px"><%=nom %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=classe %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=masse_horaire %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=coefficient %></b></td>
							</tr>
							<tr><td colspan=4 align=right><a href="#" onclick="window.print();document.location.href='recherche_matiere.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" href="#" onclick="document.location.href='recherche_matiere.jsp'">&times;</a>
