...
<% 
				...
				for( Filiere fl:flv.getALLFiliereschef(departement))
				{%>
				<tr>
				<td align="center"><%=fl.getFlr_nom()%></td>
				 <td align="center"><%=fl.getDep()%></td> 
				        <td align="center"><a href="../filiere?action=delete&id=<%=fl.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
