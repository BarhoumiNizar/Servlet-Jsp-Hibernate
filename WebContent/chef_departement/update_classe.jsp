...
<form method="post" action="../classe" id="form">
  <div class="group">
  <input type="hidden" name="action" value="update">
  <input type="hidden" name="id" value="<%=id %>">
    <input type="text" name="class_nom" value="<%=nom %>" placeholder="Nom de département">
  ...
  <div class="group">
   <label style="position: relative; top: 0px">Filiere</label>
    ...
    <% 
				...
				{%>
    <option  <%if(filiere.equalsIgnoreCase(fl.getFlr_nom())){ %> selected="selected" <%} %>><%=fl.getFlr_nom() %></option>
  <%
				}
  %>
  ...
  <button type="submit" class="button buttonBlue">Modifier Classe
