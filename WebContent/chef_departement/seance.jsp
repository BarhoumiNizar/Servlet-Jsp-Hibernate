...
<form method="post" action="../seance" id="form">
  ...
  <input type="hidden" name="action" value="ajout">
    <input type="date" name="date_debut" ><span class="highlight"></span><span class="bar"></span>
    
  </div>
  <div class="group">
    <input type="date" name="date_fin" ><span class="highlight"></span><span class="bar"></span>
  
  </div>
  <div class="group">
  <select name="id_prof">
  <option value="1"> prof1</option>
