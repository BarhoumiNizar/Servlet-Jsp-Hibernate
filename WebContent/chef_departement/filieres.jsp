...
<form method="post" action="../filiere" id="form">
  ...
  <input type="hidden" name="action" value="ajout">
    <input type="text" name="flr_nom" placeholder="Nom de Filiere" required="required">
    <span class="highlight"></span>
    <input type="hidden" name="id_dep" value="<%=departement%>">
  </div>
 
  
  
  <button type="submit" class="button buttonBlue">Créer Filiere
