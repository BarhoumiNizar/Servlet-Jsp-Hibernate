...
for( matiere mat:mt.getALLMatiere(dep))
{%>
<tr>
<td align="center"><%=mat.getMat_nom()%></td>
<td align="center"><%=mat.getClasse()%></td>
<td align="center"><%=mat.getMat_mass_horaire()%></td>
<td align="center"><%=mat.getMat_coefficient()%></td>
				        <td align="center"><a href="../matiere?action=delete&id=<%=mat.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
