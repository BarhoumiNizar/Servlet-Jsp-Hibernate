...
int i=0;
			 ...
			 i=i+1;
				...
				<tr <% if(ab.getEtat().equals("ok")) {%> bgcolor="red" <% } %>>
				<td align="center"><%=i %></td>
				<td align="center"><%=ab.getEt_matricule()%></td>
				   <td align="center"><%=ab.getDate()%></td>
				     <td align="center"><%=ab.getSeance()%></td>
				   <td align="center"><%=ab.getClasse()%></td>     
				        <td align="center"><a href="update_absence.jsp?action=update&id=<%=ab.getId()%>" >
