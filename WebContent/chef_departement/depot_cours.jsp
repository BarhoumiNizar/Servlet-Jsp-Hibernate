...
<div class="wrapper">
      ...
      <li class="treeview">
        ...
        <li class="treeview">
          <a href="notifications.jsp">
            <i class="fa fa-edit"></i> <span>Envoyer notification à l’administration </span>
           
          </a>
         </li>
        
        <li>
          <a href="depot_cours.jsp">
            <i class="fa fa-calendar"></i> <span>Déposer des cours en ligne</span>
       ...
       <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="depot_stage_pfe.jsp"><i class="fa fa-circle-o"></i> PFE</a></li>
            <li><a href="depot_stage_pfa.jsp"><i class="fa fa-circle-o"></i> PFA</a></li>
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1>Deposer cours en ligne</h1>
 
</hgroup>
<form method="post" action="../cours" enctype="multipart/form-data">
  <div class="group">
  <input type="hidden" name="action" value="ajout">
    <input type="file" name="matiere" placeholder="matiere"><span class="highlight"></span><span class="bar"></span>
    
  </div>
  <div class="group">
    <input type="text" name="classe" placeholder="classe"><span class="highlight"></span><span class="bar"></span>
