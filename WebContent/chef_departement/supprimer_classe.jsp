...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1>Supprimer Classe</h1>
 
</hgroup>
<table width="75%" align="center" border="1">
<tr><td align="center">Nom de la classe</td>
...
<% 
				...
				for( classe cl:cls.getALLClasse(dep))
				{%>
				<tr>
				<td align="center"><%=cl.getClass_nom()%></td>
				 <td align="center"><%=cl.getFiliere()%></td> 
				        <td align="center"><a href="../classe?action=delete&id=<%=cl.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
