...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  filiereInterface flvrech=new filiereImp();
						 /*Pour remplir le formulaire*/
						  for( Filiere fl:flvrech.getALLFilieres())
						  {
						...
						%>
							...
							<td width=180><b style="font-size: 18px"><%=departement %></b></td></tr>
							<tr><td colspan=2 align=right><a href="#" onclick="window.print();document.location.href='recherche_filiere.jsp'">Imprimer</a></td></tr>
