...
<td align="center"width="100">Document</td>
<td align="center"width="100">Etudiant</td>
<td align="center"width="100">Etat</td>
<td align="center"width="100">Date</td>
<td  align="center"width="100">Supprimer</td>
</tr>
<% 


				//pour parcourire le resultat users
				documentsInterface document=new documentsImp();
				for( document_administratif docs:document.getALLdemandesAdministartion())
				{%>
				<tr height="50">
				<td align="center"><%=docs.getType_document()%></td>
				<td align="center"><%=docs.getEtudiant()%></td>
				<td align="center"><%=docs.getEtat()%></td>
				<td align="center"><%=docs.getDate()%></td>
				   
				        <td align="center"><a href="../../document_administratif?action=delete&id=<%=docs.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false" >
