      ...
      <ul class="sidebar-menu"  >
        ...
        <li class="treeview">
          <a href="enregistrer_note.jsp">
            <i class="fa fa-edit"></i> <span>Enregistrer les notes </span>
           </a></li>
         ...
         <li>
          <a href="#">
            <i class="fa fa-calendar"></i> <span>Etudiants</span>
...
<tr><td align="center">Etudiant</td>
...
<% 
				...
				for(absence supp:absences.getALLAbsences())
				{%>
				<tr>
				<td align="center"><%=supp.getEt_matricule() %></td>
				<td align="center"><%=supp.getClasse() %></td>
				<td align="center"><%=supp.getDate() %></td>
				        <td align="center"><a href="../../absence?action=delete&id=<%=supp.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">Supprimer</a></td></tr>
