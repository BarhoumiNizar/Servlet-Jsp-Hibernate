...
<table width=100%>
<tr>
<td width=20%  valign="top" style="padding-top: 50px">
<table>
<tr>
<td>
  ...
  <label style="position: relative; top: 0px">Immeuble</label>
    ...
    <% 
				...
				for( Salle sls:sl.getALLSalles())
				{%>
      <option value="<%=sls.getSall_immeuble() %>" >Immeuble <%=sls.getSall_immeuble() %></option>
      <% } %>
    </select>
    ...
    <% 
				...
				{%>
      <option value="<%=sals.getSall_etage()%>" >Etage <%=sals.getSall_etage() %></option>
      <% } %>
    </select>
...
<tr height="50" bgcolor="#8CC6D7"><td align="center">Nom de salle</td>
<td align="center">Type</td>
<td align="center">Immeuble</td>
<td align="center">Etage</td>

</tr>
<%
salleInterface sn=new salleImp();
if(request.getParameter("immeuble")!=null) 
{
	String immeuble=request.getParameter("immeuble"); 
	String etage=request.getParameter("etage");
	int etag=Integer.parseInt(etage);
	//String matiere=request.getParameter("matiere"); 
				//pour parcourire le resultat users
				 
			for( Salle sns:sn.getALLSalles())
			{	if(sns.getSall_immeuble().equals(immeuble) && sns.getSall_etage()==etag)
					 {
				
				%>
				<tr height="50">
				<td align="center"><a href="impsalle.jsp?id=<%=sns.getId()%>#popup1"><%=sns.getSall_nom()%></a></td>
				 <td align="center"><%=sns.getSall_type()%></td> 
	<td align="center"><%=sns.getSall_immeuble()%></td> 
	<td align="center"><%=sns.getSall_etage()%></td> 
