...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1 style="color:blue">Recherche Payement</h1>
...
<%if(request.getParameter("matricule")!=null) 
{
	...
	//String matiere=request.getParameter("matiere"); 
				//pour parcourire le resultat users
				 payementInterface pm=new payementImp();
			for( Payement pms:pm.getAllPayements())
			{	if(pms.getEt_matricule().equals(matricule))
					 {
				
				%>
				<tr>
				<td align="center"><a href="imppayement.jsp?id=<%=pms.getId()%>#popup1"><%=pms.getEt_matricule()%></a></td>
				 <td align="center"><%=pms.getPy_tranche()%></td> 
	<td align="center"><%=pms.getPy_date()%></td> 
...
<table width="75%" align="right"><tr><td><a href="#" id="impression" style="float:right">Imprimer</a></td></tr></table>
