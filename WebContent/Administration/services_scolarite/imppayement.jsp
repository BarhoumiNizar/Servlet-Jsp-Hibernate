...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  payementInterface cl=new payementImp();
						 /*Pour remplir le formulaire*/
						  for( Payement cls:cl.getAllPayements())
						  {
							 if(cls.getId()==id_update) 
							 {
								 etudiant=cls.getEt_matricule();
								 etat=cls.getPy_tranche();
								 date=cls.getPy_date();
						...
						%>
							...
							<tr>
							<td width=180><b style="font-size: 24px;color:red">Etudiant</b></td>
							<td width=180><b style="font-size: 24px;color:red">Payement</b></td>
							<td width=180><b style="font-size: 24px;color:red">Date</b></td>
							
							</tr>
							<tr>
							<td width=180><b style="font-size: 18px"><%=etudiant %></b></td>
							<td width=180><b style="font-size: 18px"><%=etat %></b></td>
							<td width=180><b style="font-size: 18px"><%=date %></b></td>
								
						
							</tr>
							<tr><td colspan=7 align=right><a href="#" onclick="window.print();document.location.href='payement_recherche.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" href="#" style="position: relative; top:-120px;left:10px; float: right" onclick="document.location.href='payement_recherche.jsp'">&times;</a>
