...
<% 
				...
				for(Salle modif:Sall.getALLSalles())
				{%>
				<tr height="50" <% if(modif.getEtat().equals("oui")){ %> bgcolor="red" <% } %>>
				<td align="center"><%=modif.getSall_nom() %></td>
				<td align="center"><%=modif.getSall_type()%></td>
				<td align="center">Immeuble <%=modif.getSall_immeuble() %></td>
				<td align="center">Etage <%=modif.getSall_etage() %></td>
				        <td align="center"><a href="update_salle.jsp?id=<%=modif.getId()%>" >
							<img src="../../icones/modifier.png" width="30" height="30"/></a></td></tr>
