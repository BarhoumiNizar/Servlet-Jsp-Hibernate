...
<td width=20% valign="top">
  ...
  <label style="position: relative; top: 0px">Classe</label>
    ...
    <span class="highlight"></span>
     <label style="position: relative; top: 0px">Matricule</label><br>
...
<%if(request.getParameter("matricule")!=null) 
{
	...
	//String matiere=request.getParameter("matiere"); 
				//pour parcourire le resultat users
				 EtudiantInterface sn=new EtudiantImp();
			for( Etudiant sns:sn.getALLEtudiants())
			{	if(sns.getMatricule().equals(matricule))
					 {
				
				%>
				<tr>
				<td align="center"><a href="impetudiant.jsp?id=<%=sns.getId()%>#popup1"><%=sns.getMatricule()%></a></td>
				 <td align="center"><%=sns.getEt_nom()%></td> 
	<td align="center"><%=sns.getEt_prenom()%></td> 
	<td align="center"><%=sns.getClasse()%></td> 
	<td align="center"><%=sns.getEt_email()%></td> 
	<td align="center"><%=sns.getEt_adresse()%></td> 
				        </tr>
...
else if(request.getParameter("classe")!=null) 
{
