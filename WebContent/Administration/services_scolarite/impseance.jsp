...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  seanceInterface mt=new seanceImp();
						 /*Pour remplir le formulaire*/
						  for( seance mts:mt.getALLSeances())
						  {
							 if(mts.getId()==id_update) 
							 {
								 Matiere=mts.getMatiere();
								 Prof=mts.getProf();
								 Classe=mts.getClasse();
								 Jours=mts.getJours();
								 debut=mts.getDate_debut();
								 fin=mts.getDate_fin();
						...
						%>
							...
							<tr><td width=180><b style="font-size: 24px;color:red">Matiere</b></td>
							<td width=180><b style="font-size: 24px;color:red">Prof</b></td>
							<td width=180><b style="font-size: 24px;color:red">Classe</b></td>
							<td width=180><b style="font-size: 24px;color:red">Jours</b></td>
								<td width=180><b style="font-size: 24px;color:red">Début</b></td>
									<td width=180><b style="font-size: 24px;color:red">Fin</b></td>
							</tr>
							<tr>
							
							<td width=180 align="center"><b style="font-size: 18px"><%=Matiere %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=Prof %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=Classe %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=Jours %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=debut %></b></td>
							<td width=180 align="center"><b style="font-size: 18px"><%=fin %></b></td>
							</tr>
							<tr><td colspan=6 align=right><a href="#" onclick="window.print();document.location.href='recherche_seance.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" href="#"  style="float:right;position: relative; top:-150px;left:20px" onclick="document.location.href='recherche_seance.jsp'">&times;</a>
