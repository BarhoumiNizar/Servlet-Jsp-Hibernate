...
<div class="wrapper">
  ...
  <label style="position: relative; top: 0px">Etudiant</label>
    ...
    <% 
				...
				EtudiantInterface et=new EtudiantImp();
             classeInterface cl=new classeImp();
				for( Etudiant etds:et.getALLEtudiants())
				{%>
...
%>
<h1><%String etudiant=request.getParameter("etudiant"); %></h1>
...
<td  align="center">Coefficient Examen</td>
<td  align="center">date Examen</td>

</tr>
<% 
				//pour parcourire le resultat users
				notesInterface nt=new notesImp();
				for( Examen notes:nt.getALLNotes())
				{
				 if(notes.getEtudiant().equals(etudiant))
				 {
				...
				<tr height="50">
				       ...
				       <td align="center"><%=notes.getExamen_heure_debut()%></td>
				       <td align="center"><%=notes.getExamen_heure_fin()%></td>
...
%>
<h1><%String classes=request.getParameter("classe"); %></h1>
...
<% 
				...
				for( Examen notes:nt.getALLNotes())
				{
				 if(notes.getClasse().equals(classes))
				 {
