...
<% 
       ...
       //pour parcourire le resultat users
				...
				for( Payement payements:paym.getAllPayements())
				{%>
				<tr>
				 <td align="center"><%=payements.getEt_matricule()%></td>  
				<td align="center"><%=payements.getPy_tranche()%></td>
				   <td align="center"><%=payements.getPy_date()%></td>  
				  
				    
				        <td align="center"><a href="../../payement?action=delete&id=<%=payements.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false" >
                     <img src="../../icones/supprimer.png" width="40" height="40"/></a></td>
				        </tr>
