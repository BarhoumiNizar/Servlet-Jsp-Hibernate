...
<td  align="center">modifier</td></tr>
<% 
				//pour parcourire le resultat users
				EtudiantInterface etud=new EtudiantImp();
				for(Etudiant supp:etud.getALLEtudiants())
				{%>
				
				<td align="center"><%=supp.getMatricule()%></td>
				<td align="center"><%=supp.getEt_nom() %></td>
				<td align="center"><%=supp.getEt_prenom() %></td>
				
				<td align="center"><%=supp.getClasse()%></td>
				
				        <td align="center"><a href="../../etudiant?action=delete&id=<%=supp.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">Supprimer</a></td></tr>
