...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  EtudiantInterface cl=new EtudiantImp();
						 /*Pour remplir le formulaire*/
						  for( Etudiant cls:cl.getALLEtudiants())
						  {
							 if(cls.getId()==id_update) 
							 {
								 matricule=cls.getMatricule();
								 nom=cls.getEt_nom();
								 prenom=cls.getEt_prenom();
								 adresse=cls.getEt_adresse();
								 email=cls.getEt_email();
								 tel=cls.getEt_num_tel();
						...
						%>
							...
							<tr>
							<td width=180><b style="font-size: 24px;color:red">Matricule</b></td>
							<td width=180><b style="font-size: 24px;color:red">Nom</b></td>
							<td width=180><b style="font-size: 24px;color:red">Prenom</b></td>
							<td width=180><b style="font-size: 24px;color:red">Classe</b></td>
							<td width=180><b style="font-size: 24px;color:red">adresse</b></td>
							
							<td width=180><b style="font-size: 24px;color:red">Email</b></td>
							<td width=180><b style="font-size: 24px;color:red">Tel</b></td>
							</tr>
							<tr>
							<td width=180><b style="font-size: 18px"><%=matricule %></b></td>
							<td width=180><b style="font-size: 18px"><%=nom %></b></td>
							<td width=180><b style="font-size: 18px"><%=prenom %></b></td>
								<td width=180><b style="font-size: 18px"><%=classe %></b></td>
							<td width=180><b style="font-size: 18px"><%=adresse %></b></td>
							
							<td width=180><b style="font-size: 18px"><%=email %></b></td>
							<td width=180><b style="font-size: 18px"><%=tel %></b></td>
						
							</tr>
							<tr><td colspan=7 align=right><a href="#" onclick="window.print();document.location.href='etudiant_recherche.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" href="#" onclick="document.location.href='etudiant_recherche.jsp'">&times;</a>
