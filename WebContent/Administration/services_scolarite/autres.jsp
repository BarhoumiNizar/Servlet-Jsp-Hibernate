...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1>Liste demandes des Attestations de Reussites</h1>
 
</hgroup>
<table width="75%" align="center" border="1">
<tr><td align="center">Etudiant</td><td colspan="2" align="center">Validation</td></tr>
<% 
				//pour parcourire le resultat users
				documentsInterface demandes=new documentsImp();
				for(document_administratif demande:demandes.getALLdemandesReussite())
				{%>
				<tr><td align="center"><%=demande.getEtudiant() %></td><td align="center"><a href="#">Accepter</a></td>
				        <td align="center"><a href="#">Refuser</a></td></tr>
