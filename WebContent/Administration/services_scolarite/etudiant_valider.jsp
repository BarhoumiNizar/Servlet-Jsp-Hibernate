...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1>Valider Demande Inscription Etudiant</h1>
...
<td  align="center">Valider</td></tr>
<% 
				//pour parcourire le resultat users
				EtudiantInterface etud=new EtudiantImp();
				for(Etudiant vld:etud.getALLEtudiantsNonValide())
				{%>
				<tr>
				<td align="center"><%=vld.getMatricule()%></td>
				<td align="center"><%=vld.getEt_nom() %></td>
				<td align="center"><%=vld.getEt_prenom()%></td>
				<td align="center"><%=vld.getClasse() %></td>
				        <td align="center"><a href="../../etudiant?action=valider&id=<%=vld.getId()%>" onclick="if(!confirm('Voulez-vous valider')) return false">Valider</a></td></tr>
