...
<form method="post" action="../../salle" id="form">
  ...
  <input type="hidden" name="action" value="ajout">
    ...
    <option value="1">Immeuble 1</option>
    <option value="2">Immeuble 2</option>
    <option value="3">Immeuble 3</option>
  ...
  <div class="group">
  <input type="text" name="nom" placeholder="nom de la salle" required="required"><span class="highlight"></span><span class="bar"></span>
  
  </div>
  <div class="group">
    <label style="position: relative; top: 0px">Type</label>
    <select name="type" >
    <option value="salle_cour">Salle cour</option>
    <option value="amphi">Amphi</option>
    <option value="salle_tp">Salle TP</option>
  ...
  <button type="submit" class="button buttonBlue">Ajouter Salle
