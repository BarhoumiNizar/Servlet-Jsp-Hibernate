...
<form method="post" action="../../payement" id="form">
  ...
  <input type="hidden" name="action" value="ajout">
   <label style="position: relative; top: 0px">Etudiant</label>
    ...
    <% 
				...
				{%>
    <option value="<%=etuds.getMatricule()%>"><%=etuds.getMatricule() %></option>
  <%
				}
  %>
  ...
  <div class="group">
     ...
     <span style="position: relative;top: -10px"> Valide</span><input type="radio" name="py_tranche" value="valide" style="width:25px; height: 25px;border-radius:50%;position: relative;left:10px">
       <span style="position: relative;left:10px; top: -10px">Non Valide</span><input type="radio" name="py_tranche" value="non_valide" style="width:25px; height: 25px;border-radius:50%;position: relative;left:20px">
   <span class="highlight"></span><span class="bar"></span>
  
  </div>
   <div class="group">
   <input type="date" name="py_date">
   <span class="highlight"></span><span class="bar"></span>
  
  </div>
  <button type="submit" class="button buttonBlue">Payer
