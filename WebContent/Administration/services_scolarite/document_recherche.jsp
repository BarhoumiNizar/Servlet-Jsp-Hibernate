...
<td  align="center">Date dépôt</td>
<td  align="center">Date validation</td>
...
String etudiant=request.getParameter("etudiant"); 
				...
				{
				 if(doc.getEtudiant().equals(etudiant))
				 {
				...
				<tr height="50">
				       ...
				       <td align="center"><a href="impdoc.jsp?id=<%=doc.getId()%>#popup1"><%=doc.getEtudiant()%></a></td>
				       <td align="center"><%=doc.getType_document()%></td>
				       <td align="center"><%=doc.getEtat()%></td>
				        <td align="center"><%=doc.getVu()%></td>
				        <td align="center"><%=doc.getDate()%></td>
				        <td align="center"><%=doc.getDate_validation()%></td>
