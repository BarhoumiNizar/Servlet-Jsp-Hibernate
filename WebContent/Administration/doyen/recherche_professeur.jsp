...
<%if(request.getParameter("professeur")!=null) 
{
	String professeur=request.getParameter("professeur"); 
	//String professeur=request.getParameter("professeur"); 
	//String matiere=request.getParameter("matiere"); 
				//pour parcourire le resultat users
				professeursInterface prf=new professeursImp();
				for( Professeur prfs:prf.getALLProfs())
				{
					String username=prfs.getPf_nom()+" "+prfs.getPf_prenom();
					if(username.equals(professeur))
					 {
				
				%>
				<tr>
				<td align="center"><a href="impprof.jsp?id=<%=prfs.getId()%>#popup1"><%=prfs.getPf_nom()%></a></td>
				 <td align="center"><%=prfs.getPf_prenom()%></td> 
	<td align="center"><%=prfs.getPf_email()%></td> 
	<td align="center"><%=prfs.getAdresse()%></td> 
	<td align="center"><%=prfs.getPf_num_tel()%></td> 
