...
<%@page import="metier.departementInterface"%>
  ...
  <div class="content-wrapper" style="background: url('../../images/doyen_fond.png');" >
...
<% 
				...
				{%>
				<tr <% if(dep.getEtat().equals("oui")) {%> bgcolor="red" <% } %> >
				<td align="center"><%=dep.getDp_nom()%></td>
				       
				        <td align="center"><a href="update_departement.jsp?action=update&id=<%=dep.getId()%>" >
