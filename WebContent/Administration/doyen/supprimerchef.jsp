...
<% 
				...
				{%>
				<tr <% if(cfs.getEtat().equals("ok")){ %> bgcolor="red" <% } %> height="50" bgcolor="#E1E6FA">
				<td align="center"><%=cfs.getNom()%></td>
				  <td align="center"><%=cfs.getPrenom()%></td>
				   <td align="center"><%=cfs.getDepartement()%></td>
				  <td align="center"><%=cfs.getEmail()%></td>
				  <td align="center"><%=cfs.getAdresse()%></td>
				  <td align="center"><%=cfs.getNum_tel()%></td>     
				        <td align="center"><a href="../../chefcontroller?action=delete&id=<%=cfs.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false" >
                     <img src="../../icones/supprimer.png" width="30" height="30"/></a></td>
				        </tr>
