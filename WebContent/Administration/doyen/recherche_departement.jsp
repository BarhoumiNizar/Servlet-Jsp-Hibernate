...
<table width="75%" align="center" border="2" id="print">
<tr bgcolor="#8CC6D7" height="50">
<td align="center"><b style="font-size: 24px;color:red">Nom du département</b></td>
</tr>
<% 
				//pour parcourire le resultat users
				departementInterface dept=new departementImp();
				for( departement dep:dept.getALLdepartement())
				{%>
				<tr>
				<td align="center"><a style="font-size: 20px;" href="impdep.jsp?id=<%=dep.getId()%>#popup1"><%=dep.getDp_nom()%></a></td>
