...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						%>
							...
							<tr><td colspan=4 align=right><a href="#" onclick="window.print();document.location.href='recherche_seance.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" href="#" onclick="document.location.href='recherche_seance.jsp'">&times;</a>
