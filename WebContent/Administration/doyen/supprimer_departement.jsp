...
<td align="center">Nom du département</td>
...
<% 
				...
				{%>
				<tr>
				<td align="center"><%=dep.getDp_nom()%></td>
				        <td align="center"><a href="../../departement?action=delete&id=<%=dep.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
