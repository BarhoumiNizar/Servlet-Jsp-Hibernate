...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  professeursInterface cl=new professeursImp();
						 /*Pour remplir le formulaire*/
						  for( Professeur cls:cl.getALLProfs())
						  {
							 if(cls.getId()==id_update) 
							 {
								 nom=cls.getPf_nom();
								 prenom=cls.getPf_prenom();
								 adresse=cls.getAdresse();
								 email=cls.getPf_email();
								 tel=cls.getPf_num_tel();
						...
						%>
							...
							<tr><td colspan=5 align=right><a href="#" onclick="window.print();document.location.href='recherche_professeur.jsp';">Imprimer</a></td></tr>
							
							</table> 
							<a class="close" href="#" onclick="document.location.href='recherche_professeur.jsp'">&times;</a>
