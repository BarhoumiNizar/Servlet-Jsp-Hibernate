...
<!-- debut popup -->
   <div id="popup1" class="overlay">
						...
						String id=request.getParameter("id");
						  ...
						  departementInterface deps=new departementImp();
						 /*Pour remplir le formulaire*/
						  for( departement dep:deps.getALLdepartement())
						  {
							 if(dep.getId()==id_update) 
							 {
								 nom=dep.getDp_nom();
						...
						%>
							...
							<tr><td colspan=2 align=right><a href="#" onclick="window.print();document.location.href='recherche_departement.jsp';">Imprimer</a></td></tr>
