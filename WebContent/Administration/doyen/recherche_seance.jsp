...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
  <h1 style="color:blue">Recherche Seance</h1>
...
<td width=20% valign="top">
  ...
  <label style="position: relative; top: 0px">Classe</label>
    ...
    <span class="highlight"></span>
     <label style="position: relative; top: 0px">Matiere</label><br>
    <select name="matiere">
    <% 
				//pour parcourire le resultat users
				matiereInterface mtrech=new matiereImp();
				for( matiere mtsmtrech:mtrech.getALLMatieres())
				{%>
      <option><%=mtsmtrech.getMat_nom() %></option>
      <% } %>
    </select>
     <button type="submit" class="button buttonBlue" style="width:120px;">Consulter
    ...
    <span class="highlight"></span>
    <span class="highlight"></span>
     <label style="position: relative; top: 0px">Professeur</label><br>
    ...
    <% 
				...
				{%>
      <option><%=profs.getPf_nom()+" "+profs.getPf_prenom() %></option>
      <% } %>
    </select>
    <span class="highlight"></span>
...
<table width="100%" align="center" border="5" id="print" >
...
<%if(request.getParameter("classe")!=null) 
{
	...
	//String matiere=request.getParameter("matiere"); 
				...
				for( seance sns:sn.getALLSeances())
				{
					if(sns.getClasse().equals(classe))
					 {
				
				%>
				<tr height="50">
				<td align="center"><a href="impseance.jsp?id=<%=sns.getId()%>#popup1"><%=sns.getMatiere()%></a></td>
				 <td align="center"><%=sns.getProf()%></td> 
	<td align="center"><%=sns.getClasse()%></td> 
	<td align="center"><%=sns.getJours()%></td> 
	<td align="center"><%=sns.getDate_debut()%></td> 
	<td align="center"><%=sns.getDate_fin()%></td> 
				        </tr>
...
else if(request.getParameter("matiere")!=null) 
{
	...
	String matiere=request.getParameter("matiere"); 
				...
				for( seance sns:sn.getALLSeances())
				{
					if(sns.getMatiere().equals(matiere))
					 {
...
else if(request.getParameter("professeur")!=null) 
{
	//String classe=request.getParameter("classe"); 
	String professeur=request.getParameter("professeur"); 
	//String matiere=request.getParameter("matiere"); 
				...
				for( seance sns:sn.getALLSeances())
				{
					if(sns.getProf().equals(professeur))
					 {
...
<table width="75%" align=center><tr><td><a href="#" id="impression" style="float:right">Imprimer</a></td></tr></table>
