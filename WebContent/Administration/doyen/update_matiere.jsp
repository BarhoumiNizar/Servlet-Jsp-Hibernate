...
<div class="wrapper">
  ...
  for(matiere mat:mt.getALLMatieres())
  {
	 if(mat.getId()==id_update) 
	 {
		 nom=mat.getMat_nom();
		 coefs=mat.getMat_coefficient();
		 vh=mat.getMat_mass_horaire();
		 classe=mat.getClasse();
...
<form method="post" action="../../matiere" id="form">
  <div class="group">
  <input type="hidden" name="action" value="update">
   <input type="hidden" name="id" value="<%=id %>">
    <input type="text" name="mat_nom" placeholder="Nom de matiere" value="<%=nom %>">
    <span class="highlight"></span>
    
  </div>
   <div class="group">
  
    <input type="number" name="mat_mass_horaire" placeholder="masse horaire" value="<%=vh%>">
    <span class="highlight"></span>
  ...
  <div class="group">
   <label style="position: relative; top: 0px">Classe</label>
    <select name="id_classe" style="color: #636363" class="button" >
    <% 
  ...
  <div class="group">
    ...
    <input type="text" name="mat_coefficient" placeholder="coefficient" value="<%=coefs%>">
    <span class="highlight"></span>
    
  </div>
  <button type="submit" class="button buttonBlue">modifier Matiere
