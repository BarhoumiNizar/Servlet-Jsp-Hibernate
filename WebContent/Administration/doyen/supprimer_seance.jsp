...
{%>
<tr height="50">
<td align="center"><%=sean.getMatiere()%></td>
				<td align="center"><%=sean.getProf()%></td>
				<td align="center"><%=sean.getClasse()%></td>
				<td align="center"><%=sean.getJours()%></td>
				
<td align="center"><%=sean.getDate_debut()%></td>
<td align="center"><%=sean.getDate_fin()%></td>

				        <td align="center"><a href="../../seance?action=delete&id=<%=sean.getId()%>" onclick="if(!confirm('Voulez-vous supprimer')) return false">
