...
<td align="center">Masse horaire</td>
...
<%if(request.getParameter("classe")!=null) 
{
	String classe=request.getParameter("classe"); 
				...
				{
					if(mts.getClasse().equals(classe))
					 {
				
				%>
				<tr>
				<td align="center"><a href="impmatiere.jsp?id=<%=mts.getId()%>#popup1"><%=mts.getMat_nom()%></a></td>
				 <td align="center"><%=mts.getClasse()%></td> 
	<td align="center"><%=mts.getMat_mass_horaire()%></td> 
	<td align="center"><%=mts.getMat_coefficient()%></td> 
				        </tr>
