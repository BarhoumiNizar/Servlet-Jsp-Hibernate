...
<div class="wrapper">
  ...
  for(departement dp:dep.getALLdepartement())
  {
	 if(dp.getId()==id_update) 
	 {
		 nom=dp.getDp_nom();
...
<form method="post" action="../../departement" id="form">
  <div class="group">
  <input type="hidden" name="action" value="update">
  <input type="hidden" name="id" value="<%=id %>">
    <input type="text" name="dp_nom" value="<%=nom %>" placeholder="Nom de département">
  ...
  <button type="submit" class="button buttonBlue">Modifier département
