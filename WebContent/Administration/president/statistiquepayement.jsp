...
<%
 ...
 List<Etudiant> va = Etudiants.StatistiquePayementValide();
 List<Etudiant> nva = Etudiants.StatistiquePayementNonValide();
 List<Etudiant> tot = Etudiants.getALLEtudiants();
 int valide=va.size();
 int nonvalide=nva.size();
 double total=tot.size();
 double test=(valide*100)/total;
 DecimalFormat df = new DecimalFormat("00.00");
 
 String valid="Pourcentage des Etudiants tunisiens = "+df.format(test)+"%\n";
	String nvalid="Pourcentage des Etudiants étranger = "+df.format((100-test))+"%\n";
 %>
<!DOCTYPE html>
<html>
<head>
