...
<%
 ...
 List<Etudiant> info = Etudiants.StatistiqueGenieInfo();
 List<Etudiant> Linfo = Etudiants.StatistiqueLicenceInfo();
 List<Etudiant> res = Etudiants.StatistiqueLicenceReseaux();
 int Ginfo=info.size();
 int Linfor=Linfo.size();
 double reseaux=res.size();
 DecimalFormat df = new DecimalFormat("00.00");
 //String prMas="Pourcentage des masculin = "+df.format((100*masculin)/total)+"%\n";
	//String prFm="Pourcentage des Feminins = "+df.format((100*feminin)/total)+"%\n";
 %>
<!DOCTYPE html>
<html>
<head>
  ...
  <link href="../../libs/css/sDashboard.css" rel="stylesheet">
		...
		<script type="text/javascript">
			$(function() {
				...
				var dashboardJSON = [{
					widgetTitle : "Statistique des etudiants par filiere",
					widgetId : "id006",
					widgetType : "chart",
					widgetContent : {
			...
			myExampleData.pieChartData = [{
				...
				data : [[0, <%=Linfor%>]],
				label : "licence fondamentale en informatique"
			}, {
				data : [[0, <%=reseaux%>]],
				label : "Licence applique en reseaux informatique"
			}];
    ...
    <section class="sidebar">
      ...
      <li>
         ...
         <ul class="treeview-menu">
            <li><a href="statistiquefiliere.jsp"><i class="fa fa-circle-o"></i> La répartition des étudiants par filiere </a></li>
