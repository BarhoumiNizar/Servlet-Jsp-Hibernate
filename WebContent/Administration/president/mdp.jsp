...
// Object prenom=session.getAttribute("prenom");
 ...
 //String username=prenom.toString();
 //String prof=name+" "+username;
 
 %>
</hgroup>
<form method="post" action="../../Administrations" id="form">
  <div class="group">
  <input type="hidden" name="action" value="modifier_presidentMdp">
  ...
  <div class="group">
    ...
    <input type="text" name="mdps" placeholder="Nouveau Mot de passe" required="required">
    <span class="highlight"></span>
    
  </div>
  <div class="group">
  <input type="hidden" name="id" value="<%=ids%>">
    <input type="text" name="pwds" placeholder="Confirmer Mot de passe" required="required">
    <span class="highlight"></span>
  ...
  <button type="submit" class="button buttonBlue">Modifier Password
