...
<form method="post" action="../../Administrations" id="form">
  <div class="group">
  <input type="hidden" name="action" value="modifier_presidentLogin">
  ...
  <input type="hidden" name="id" value="<%=ids%>">
    <input type="text" name="log" placeholder="Confirmer login" required="required">
    <span class="highlight"></span>
  ...
  <button type="submit" class="button buttonBlue">Modifier Login
