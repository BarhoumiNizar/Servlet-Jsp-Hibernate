...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background:url('../images/etudiant_fond.jpg');">
    ...
    <div style="width:900px;margin: auto">
       ...
       <!-- Le contenu -->
       <hgroup>
   <h1>Notification <u><b></b></u> </h1>
  
</hgroup>
<table width="75%" align="center" border="5">
<tr bgcolor="#8CC6D7" height="50"><td align="center">Date </td><td align="center">Type</td><td align="center">Contenu</td>
...
<%
				...
				notificationInterface notes=new notificationImp();
Object classe = session.getAttribute("classe");
String classes=classe.toString();
				for(notification note:notes.getNotifications(classes))
				{
					
				%>
				<tr height="50">
					<td align="center"><%=note.getDate_notification() %></td>
					<td align="center"><%=note.getType()%></td>
					<td align="center"><%=note.getContenu()%></td>
					<td align="center"><%=note.getProf()%></td>
