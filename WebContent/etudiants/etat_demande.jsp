...
<div class="wrapper">
  ...
  <div class="content-wrapper"  style="background: url('../images/etudiant_fond.jpg');">
    ...
    <div style="width:900px;margin: auto;padding-top: 50px">
       ...
       <%
    	   Object etudiants=session.getAttribute("matricule");
    	   String etudiant=etudiants.toString();
...
%>   
 ...
 <table width="75%" align="center" border=2 style=" border:5px solid black;" >
<tr bgcolor="#8CC6D7" height="50">

<td  align="center">Type document</td>
<td  align="center">Etat</td>
<td  align="center">Date de la demande</td>
<td  align="center">Date de traitement</td>
...
<% 
				...
				for( document_administratif docs:doc.EtatDemande(etudiant))
				{%>
				<tr height="50" bgcolor="#E1E6FA">
				 <td align="center"><%=docs.getType_document()%></td>
				       
				       <td align="center"><%=docs.getEtat()%></td>
				        <td align="center"><%=docs.getDate()%></td>
				        <td align="center"><%=docs.getDate_validation()%></td>
				       <td align="center">
				       <% if(docs.getDate_validation().equals("non_valide")) {%>
				       
				        <img src="../icones/vu.png" height="50" width="50"/>
				       <% }
				       else{
				       %>
				       <a href="../document_administratif?action=vu&etat=consulter&id=<%=docs.getId()%>">
                   <img src="../icones/vu.png" height="50" width="50"/>
                   </a>
                   <% } %></td>
				        </tr>
