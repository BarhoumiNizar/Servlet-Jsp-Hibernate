...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="background:url('../images/etudiant_fond.jpg');">
...
%>
   <h1>Sujet PFA <u><b></b></u> </h1>
  
</hgroup>
<table width="75%" align="center" border="5">
<tr bgcolor="#8CC6D7" height="50">
<td align="center">Sujet</td><td align="center">Date debut</td><td align="center">Date Fin</td>
...
String classe = (String) session.getAttribute("classe");
				for(stage stg:stag.getStagePfa(classe))
				{
					
				%>
				<tr height="50">
				<td align="center"><%=stg.getStg_sujet() %></td>
				<td align="center"><%=stg.getStg_date_debut()%></td>
				<td align="center"><%=stg.getStg_date_fin()%></td>
				<td align="center"><%=stg.getStg_entreprise()%></td>
				<td align="center"><%=stg.getProf()%></td>
