...
<form method="post" action="../etudiant" id="form">
  ...
  <label style="position: relative; top: 0px">Date naissance</label>
    <input type="date" name="naissance" placeholder="naissance" required="required"><span class="highlight"></span><span class="bar"></span>
   ...
   <span style="position: relative;top: -10px"> Masculin</span><input type="radio" name="sexe" value="masculin" style="width:25px; height: 25px;border-radius:50%;position: relative;left:10px" required="required">
       <span style="position: relative;left:10px; top: -10px">Féminin</span><input type="radio" name="sexe" value="feminin" style="width:25px; height: 25px;border-radius:50%;position: relative;left:20px" required="required">
  ...
  <div class="group">
    <input type="text" name="tel" placeholder="téléphone" required="required"><span class="highlight"></span><span class="bar"></span>
  ...
  <div class="group">
    <input type="password" required="required" name="password" placeholder="password"><span class="highlight"></span><span class="bar"></span>
