...
String etudiants=matricule.toString();

				//pour parcourire le resultat users
				documentsInterface document=new documentsImp();
				for( document_administratif docs:document.getDemandes(etudiants))
				{%>
				<tr height="50" <% if(docs.getEtats().equals("oui")){ %> bgcolor="red" <% } %>>
				<td align="center"><%=docs.getType_document()%></td>
				  <td align="center"><%=docs.getEtat()%></td>
				  <td align="center"><%=docs.getDate()%></td> 
				        <td align="center"><a href="update_document.jsp?action=update&id=<%=docs.getId()%>" >
